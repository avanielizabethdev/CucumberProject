...
public class CalculatorSteps {
	...
	@When("The values {int} and {int} are added")
	public void the_values_and_are_added(int num1, int num2) {
	    // Write code here that turns the phrase above into concrete actions
	...
	@When("The values {int} and {int} are substracted")
	public void the_values_and_are_substracted(int num1, int num2) {
	    // Write code here that turns the phrase above into concrete actions
